  ...
  return (
    <>
      ...
      <motion.header
        ...
        className={cn(
          // NOTE: keep a fixed height so we can offset the page content below
        ...
        <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  {searchOpen && (
                    <motion.div
                      ...
                      className={cn(
                        ...
                        "bg-background border border-border/20 rounded-2xl shadow-2xl z-50 overflow-hidden",
                      )}
                      role="dialog"
          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                <div className="px-4 pb-4 space-y-1 bg-background/80 backdrop-blur-xl border-t border-border/20">
      ...
      {/* Offset below header to prevent content being hidden behind fixed navbar */}
