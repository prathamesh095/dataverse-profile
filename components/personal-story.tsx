...
// Dynamic imports with named exports & loading UI
...
/** AnimatedButton wrapper – consistent hover/tap animation */
  ...
  ({ activity }: { activity: { icon: any; title: string; description: string; tags?: string } }) => (
    <div className="bg-card/90 backdrop-blur-sm p-4 rounded-lg hover:bg-card transition-all duration-300 hover:shadow-lg group/activity border border-border/50">
      <div className="flex items-center mb-2">
        <activity.icon className="w-4 h-4 text-primary mr-2" />
...
// ============================
// Static content with improved professional wording
// ============================
    ...
    () => ({
      education: [
        ...
        },
        {
          ...
          subtitle: "",
          institution: "KBP College, Islampur, Maharashtra",
          period: "2020 – 2021",
      ...
      extracurricular: [
        {
          ...
          title: "Hackathons",
          description:
            "Successfully cleared the first two rounds of the TATA Crucible Hackathon and qualified at the college level for the Smart India Hackathon.",
        ...
        },
        {
          ...
          title: "Leadership",
          description:
            "Led a student team in the Smart India Hackathon and contributed to organizing major technical activities within the college.",
          tags: "Team Leadership, Coordination",
        },
        {
          icon: Code,
          title: "Competitions",
          description:
            "Achieved AIR 126 in the Naukri.com Data Science Quiz, showcasing strong analytics and statistical reasoning skills.",
      ...
      training: [
        {
          ...
          year: "2025",
          topics: "Machine Learning, SQL, Python, Power BI, Visualization",
          certLink:
            "https://drive.google.com/file/d/1Jh7JCixX5itk2CUEz6XWz3YtcLuFCd0v/view?usp=sharing",
        },
        {
          title: "Python for Data Science", provider: "IBM", year: "2023",
          topics: "Python, Data Analysis, Data Science, Visualization",
          certLink:
            "https://www.credly.com/badges/2b0fb2e3-8c92-4c0a-bb61-c10209e2785d/public_url",
        },
        {
          title: "Data Analytics", provider: "Cisco Networking Academy", year: "2025",
          topics: "BigQuery, Data Studio, Analytics",
          certLink:
      ...
      hobbies: [
        {
          ...
          description:
            "Exploring new technologies, research papers, and online courses to stay updated with advancements in data science.",
          link: "/blog",
        },
        {
          icon: Camera,
          title: "Photography",
          description:
            "Capturing moments through the lens — a hobby that enhances creative thinking and pattern recognition.",
          link: "/gallery",
        },
        {
          icon: Coffee,
          ...
          description:
            "I enjoy thoughtful discussions over coffee — a simple space where curiosity and ideas naturally grow.",
          link: "/contact",
        },
      ],

      funFacts: [
        { number: "500+", label: "Cups of coffee enjoyed while coding" },
...
export function PersonalStory() {
  ...
  return (
    <div className="space-y-8 mb-8 relative">
      {/* FIXED FLOATING BACKGROUND EFFECTS */}
        ...
        <Card className="group border-0 bg-card backdrop-blur-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
          <CardContent className="relative p-8 z-10">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                I completed my Bachelor’s in Mechanical Engineering at Shivaji University
                in 2025. Along the way, I discovered how data transforms complexity into clarity —
                shifting my focus from mechanical systems to building reliable, data-driven solutions.
              </p>

              <p>
                Through hackathons, hands-on projects, and continuous learning, I developed a
                blended discipline of engineering rigor, statistical thinking, and modern machine
                learning practices.
              </p>

              <p>
                Today, my work focuses on translating business problems into actionable analytics:
                reproducible pipelines, interpretable models, and insights that drive real-world impact.
              </p>
            </div>
          ...
          <CardContent className="relative p-8 z-10">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p className="leading-relaxed">
                Great data work is useful, trustworthy, and adopted. I build around three principles:
              </p>

              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 mr-4" />
                  <div>
                    <p className="font-semibold mb-1">Business Impact First</p>
                    <p className="text-sm">
                      Every analysis should tie to a clear decision and measurable outcome.
                    </p>
                  </div>
                </div>

                <div className="flex items-start">
                  <div className="w-3 h-3 bg-accent rounded-full mt-2 mr-4" />
                  <div>
                    <p className="font-semibold mb-1">Engineering for Reliability</p>
                    <p className="text-sm">
                      Reproducibility, versioned data, tests, and monitoring ensure insights don’t break.
                    </p>
                  </div>
                </div>

                <div className="flex items-start">
                  <div className="w-3 h-3 bg-secondary rounded-full mt-2 mr-4" />
                  <div>
                    <p className="font-semibold mb-1">Continuous Learning & Clarity</p>
                    <p className="text-sm">
                      The field evolves quickly — clear communication and ongoing learning are essential.
                    </p>
                  </div>
                </div>
              </div>
      ...
      {/* EDUCATION SECTION */}
      <Card className="group border-0 bg-card backdrop-blur-lg hover:shadow-2xl transition-all duration-500">
        <CardContent className="relative p-8 z-10">
      ...
      {/* Hobbies */}
      <Card className="group border-0 bg-card backdrop-blur-sm hover:shadow-2xl transition-all duration-500">
        <CardContent className="relative p-8 z-10">
      ...
      <Card className="group border-0 bg-card backdrop-blur-sm hover:shadow-2xl transition-all duration-500">
        <CardContent className="relative p-8 z-10">
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-8">
            ...
            >
              <a href="https://www.linkedin.com/in/prathamesh095" target="_blank">
            ...
            <AnimatedButton
              ...
              className="btn-outline-premium"
            >
              <a href="https://github.com/prathamesh095" target="_blank">
